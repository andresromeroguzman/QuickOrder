						...
						<div class="table-responsive">
							<table border="5px" class="table">
								...
								<tr style="color: black">
									...
									<td>
										<!-- Botones de accion -->
									<a href="#" onclick="ProductOnlick('Edit',<?php echo $Rows[0]; ?>)"><span style="color: green;"><abbr title ="Editar"><i class="fa-solid fa-pencil fa-xl"></i></abbr></span></a> |
									<a href="#" onclick="ProductOnlick('Delete',<?php echo $Rows[0]; ?>)"><span style="color: Tomato;"><abbr title ="Eliminar"><i class="fa-solid fa-trash-can fa-xl"></i></abbr></span></a>
									</td>
									<?php endwhile; ?>
								</tr>
							</table>
